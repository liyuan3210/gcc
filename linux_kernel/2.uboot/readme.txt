...
bootloader安装：bootloaderInstall.jpg

bootloader分两种启动流程：
	·单阶段
	·多阶段
	大多数bootloader采用两阶段的，也就是多阶段。
	1>stage1:完成硬件初始化，为stage2准备内存空间，并将stage2复制到内存中，设置堆栈,跳到stage2中。
	2>stage2:也就是c入口处，初始化本阶段要使用到的硬件设备，将内核文件与根文件系统从flash拷贝到ram中，最后调用内核
